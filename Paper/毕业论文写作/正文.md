...
有研究对两骨折块之间的相对位移与愈合的关系做了动物研究，使用了动物模型，研究表明，在一期愈合的动物中，最大相对位移为0.15，而其他未一期愈合的动物中，相对位移均超过0.15，故0.15的相对位移为一期愈合的临界值，本研究采用了此数值作为判断依据，来判断是否可以达到一期愈合，为量化两骨折块间的最大相对位移，本研究将乙状切迹骨折线处的最高点作为原点，通过关注在施加载荷之后，两点之间的直线距离，来判断最大相对位移的距离。
